...
RNA Polymerase III (Pol III), the largest of the three at 17-subunits[@vannini2012], produces a series of non-coding RNAs, including U6 snRNA, 5S rRNA and transfer RNA (tRNA)[@dieci2007].
...
Initiation of tRNA transcription requires the binding of TFIIIC, a multisubunit complex, to internal tRNA promoters, the A and B boxes, which are located downstream of the transcription start site [@Schramm2002; @Lassar1983].
...
-   tumours express tRNAs that are absent from the normal tissue of origin [@kuchino1978].

-    proliferative and oncogenic effects can result from small increases in levels of tRNA~i~^Met^, the tRNA that mediates translation initiation [@marshall2008].

-   For example, half of the tRNA genes were considered unbound by Pol III in one analysis of HeLa cells^[11](https://www.nature.com/articles/nrg3001#ref-CR11 "Oler, A. J. et al. Human RNA polymerase III transcriptomes and relationships to Pol II promoter chromatin and enhancer-binding factors. Nature Struct. Mol. Biol. 17, 620–628 (2010).")^.
...
Early studies demonstrated that FOXA1 overlaps with \~50% of ER-chromatin binding sites prior to ER binding, suggesting that binding is facilitated by chromatin opening by FOXA1 [@carroll2005; @laganière2005].

-   Additionally, silencing of FOXA1 reduced 90% ER binding events

-   FOXA1 Determines Treatment Response in ER+ Breast Cancer

    -   FOXA1 Recruits Growth Inhibitors in ER+

    -   ERα-positive breast cancer with high FOXA1 expression shows favorable sensitivity to endocrine therapy [[**56**](https://www.mdpi.com/2072-6694/9/3/22#B56-cancers-09-00022)]
