...
Peaks were classified as binding events if Q-values exceeded input values.
...
H3K27ac decreased to 266 (63.9%) (Figure \@ref(fig:results-1)C).
Here, FOXA1 co-binds represents 92.5% of H3K27ac sites.
...
-   50% tDNAs active/inactive

```{=html}
<!-- -->
```
-   tRNAs were classified as 'active' if H3K27ac Q-values exceeded the median -DOX value (Q \> 1.808).
...
-   where fox/h3 gaines, how many gain activity?
    how many were already active?
