...
Forkhead box A1 (FOXA1) is a pioneer factor capable of directly initiating chromatin opening, facilitating binding of ERα and other transcription factors[@Costa1989; @Cirillo2002; @carroll2005; @laganière2005].
...
```{r methods, out.width = '100%', fig.cap = "Overview of bioinformatic pipeline. "}
...
## tDNAs are activated by FOXA1 OE
...
## FOXA1 OE influences the binding location of FOXA1 and H3K27ac
...
```{r motifs, out.width = '100%', fig.cap = ""}
...
kbl(data.frame(
    ...
    "-DOX Activity" = ed,
    "+Dox Activity" = dox,
    "FOXA1 Fold Change" = fox,
    "H2K27ac Fold Change" = h3),
    booktabs = TRUE,
    caption = ".",
    format = "markdown"
)
