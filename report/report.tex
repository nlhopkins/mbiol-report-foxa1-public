...
Upon FOXA1 OE, the mean Q-values for FOXA1 binding significantly decreased 0.16-fold and insignificantly decrease by 0.62-fold for H3K27ac (Mann-Whitney: p \textless0.005) (Supplementary Figures X).
...
\hypertarget{what-1}{%
\subsubsection{What?}\label{what-1}}
